      ...
      <div className="container mx-auto px-4 sm:px-6 py-10 sm:py-16">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 sm:gap-12 mb-10 sm:mb-12">
          <div className="col-span-1 md:col-span-2 lg:col-span-2">
            ...
            <p className="text-sm text-muted-foreground leading-relaxed mb-4 sm:mb-6 max-w-md">
        ...
        <div className="pt-6 sm:pt-8 border-t border-border flex flex-col sm:flex-row justify-between items-center gap-4">
          ...
          <div className="flex space-x-6">
            ...
            <Link href="/terms" className="text-xs sm:text-sm text-muted-foreground hover:text-accent transition-colors">
              Terms of Service
            </Link>
            <Link href="/sitemap.xml" className="text-xs sm:text-sm text-muted-foreground hover:text-accent transition-colors">
              Sitemap
            </Link>
          </div>
        </div>
