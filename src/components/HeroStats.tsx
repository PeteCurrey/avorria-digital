...
const StatCard = ({
  ...
  return <Card style={{
    animationDelay: `${delay}ms`
      ...
      <CardContent className="p-4 sm:p-6 text-center rounded-sm opacity-100">
        <div className="text-3xl sm:text-4xl font-light text-accent mb-1 sm:mb-2">{value}</div>
        <p className="text-xs sm:text-sm text-muted-foreground leading-relaxed">{label}</p>
      </CardContent>
    </Card>;
};
const HeroStats = () => {
  ...
  return <div className="grid grid-cols-2 lg:grid-cols-4 gap-3 sm:gap-6 w-full">
