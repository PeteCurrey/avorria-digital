...
const AdminLayout = ({ children, title, subtitle }: AdminLayoutProps) => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-background via-background to-secondary/10">
      ...
      >
        {/* Top Bar */}
        <header className="sticky top-0 z-20 flex h-14 items-center justify-between border-b border-border/20 bg-card/60 px-4 backdrop-blur-xl lg:px-6 after:absolute after:bottom-0 after:left-0 after:right-0 after:h-px after:bg-gradient-to-r after:from-transparent after:via-accent/15 after:to-transparent">
