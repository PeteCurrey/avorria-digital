    ...
    <body>
      <div class="page">
        <div class="header">
          ...
          <div class="date">Design Brief â€¢ ${today}</div>
        </div>
        
        <div class="title-section">
          <h1 class="title">${brief.projectOverview.businessName || 'Your'} Website Design Brief</h1>
          <p class="subtitle">${brief.projectOverview.industry} â€¢ AI-Generated Strategic Blueprint</p>
        </div>
        ...
        <div class="footer">
          <p class="footer-text">Generated by Avorria AI Design Consultant â€¢ avorria.com</p>
        </div>
      </div>
    </body>
    </html>
...
export const DesignBriefChat = ({ 
  ...
  useEffect(() => {
    if (isOpen && messages.length === 0) {
      ...
      setMessages([{
        role: "assistant",
        content: "Hi! I'm your AI design consultant. I'm here to help you create a comprehensive design brief for your website.\n\nLet's start with the basics â€” tell me about your business. What do you do, and what makes you different from others in your space?"
      }]);
    }
