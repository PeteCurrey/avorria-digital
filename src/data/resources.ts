...
Use Hotjar or Microsoft Clarity to see where people are clicking, how far they're scrolling, and where they're dropping off.

## Redesign vs Optimisation: When You Need Which

Not every underperforming website needs a full rebuild.

**Optimise (faster, cheaper) if:**
- The design is less than 3 years old
- Core functionality works
- The problem is content, CTAs, or conversion rate

**Redesign (bigger investment) if:**
- The site is 5+ years old and looks dated
- It's not mobile-friendly
- The underlying CMS or tech stack is broken
- You're rebranding or repositioning

Most businesses jump to redesign when optimisation would get them 80% of the result for 20% of the cost.

## How Avorria Approaches Web Projects

At Avorria, we don't build websites to win design awards. We build them to generate pipeline.

Our process:

### Phase 1: Discovery & UX Mapping (Week 1–2)
- Stakeholder interviews
- Competitor analysis
- User journey mapping
- Wireframes and structure

### Phase 2: Design & Content (Week 3–5)
- High-fidelity designs in Figma
- Copywriting that speaks to outcomes
- Review cycles with your team

### Phase 3: Development & Testing (Week 6–8)
- Build on modern stack (Next.js, Webflow, or WordPress depending on needs)
- Speed and mobile optimisation
- Cross-browser and device testing

### Phase 4: Launch & Optimisation (Week 9–12)
- Staged rollout with monitoring
- Heatmaps and session recording setup
- A/B testing on key pages
- Conversion rate tracking and iteration

We don't disappear after launch. The first 90 days post-launch are where the real optimisation happens.

## Next Steps

If your website is costing you leads—whether through poor conversion rates, slow speed, or outdated design—we can fix it.

We offer:
- **Full website audits** (UX, speed, conversion, SEO)
- **Conversion-focused redesigns** for service businesses
- **Landing page builds** for campaigns

No 60-page proposals. Just a clear breakdown of what's broken, what it'll cost to fix, and what you'll get in return.

**[Book a Strategy Call](#)** or **[Request a Free Website Audit](#)**
`,
  },
  {
    id: "marketing-analytics-tracking",
    title: "Marketing Analytics & Tracking: Stop Flying Blind",
    slug: "marketing-analytics-tracking-playbook",
    summary: "Most marketing reports are noise. Here's how to set up tracking and analytics that actually show what's driving revenue—and what's wasting budget.",
    category: "Analytics",
    readingTime: 14,
    serviceRelation: "analytics",
    isPillar: true,
    targetKeyword: "marketing analytics tracking",
    metaTitle: "Marketing Analytics & Tracking: Stop Flying Blind | Avorria",
    metaDescription: "How to set up marketing analytics and tracking that actually matters. Stop drowning in reports and start measuring what drives revenue.",
    publishedDate: "2025-02-01",
    content: `## Why Most Reporting Is Noise

You're paying for marketing. You're getting reports. But can you answer these questions?

- Which campaigns are driving qualified leads?
- What's your real cost per customer (not just cost per click)?
- Which traffic sources convert best?
- Where are prospects dropping off in your funnel?

If the answer is "I'm not sure" or "it's complicated," your reporting is noise, not signal.

Most agencies bury clients in dashboards full of metrics that don't matter:
- Impressions (nobody cares how many times your ad was shown if nobody clicked)
- Page views (traffic that doesn't convert is just a cost)
- Social followers (vanity metric unless you're an influencer)

This guide will show you how to set up tracking and reporting that actually matters.

## Key Numbers That Actually Matter

Strip away 90% of your current marketing reports. Focus on these:

### 1. Lead Volume
How many qualified enquiries are you generating per month?

Not form fills from tyre-kickers—actual prospects who match your ICP (ideal customer profile).

### 2. Cost Per Qualified Lead
Total marketing spend ÷ qualified leads.

This tells you whether your acquisition is efficient. If you're spending £5,000/month and generating 10 qualified leads, your CPL is £500.

If your average customer value is £2,000, that's healthy. If it's £600, you're losing money.

### 3. Pipeline Value
What's the total value of opportunities currently in your sales pipeline that came from marketing?

This requires CRM integration, but it's the only way to tie marketing to revenue.

### 4. Marketing-Sourced Revenue
How much closed revenue came from marketing-generated leads?

Track this monthly. If marketing isn't contributing to revenue, something's broken.

### 5. ROAS (Return on Ad Spend)
Revenue generated ÷ ad spend.

Only relevant for paid campaigns. A 3:1 ROAS means you're generating £3 in revenue for every £1 spent on ads.

Benchmarks vary by industry, but anything below 2:1 is usually unsustainable.

### 6. Conversion Rate by Stage
What % of visitors become leads? What % of leads become opportunities? What % of opportunities close?

Knowing where prospects drop off tells you where to focus optimisation effort.

## Setting Up a Single Source of Truth

The biggest problem with marketing analytics is fragmentation. Your data lives in six places:
- Google Analytics (website traffic)
- Google Ads (paid campaign data)
- Meta Ads Manager (Facebook and Instagram)
- CRM (lead and pipeline data)
- Email platform (campaign opens and clicks)
- Spreadsheets (where you manually pull it all together)

This is inefficient and error-prone.

You need a **single source of truth**—one place where all marketing data flows.

### Option 1: CRM as the Hub (Recommended for Most)
Use your CRM (HubSpot, Pipedrive, Salesforce) as the central system.

- Connect Google Analytics and ad platforms via integrations
- Ensure all leads are captured in the CRM with source attribution
- Build dashboards in the CRM showing lead volume, pipeline, and revenue by source

**Pros:** Your sales team already lives here. Marketing and sales see the same data.

**Cons:** CRM dashboards can be clunky.

### Option 2: Data Warehouse + BI Tool (For Larger Teams)
Send all data to a warehouse (BigQuery, Snowflake) and visualise in a BI tool (Looker, Tableau, Power BI).

**Pros:** Unlimited customisation, handles complex multi-touch attribution.

**Cons:** Expensive, requires technical setup.

### Option 3: All-in-One Marketing Platform (HubSpot, Marketo)
If you're using an all-in-one platform, their native dashboards may be enough.

**Pros:** Everything in one place, no integrations needed.

**Cons:** Expensive, and you're locked into their ecosystem.

## Attribution Basics (Practical, Not Academic)

Attribution is how you assign credit for a conversion when a prospect interacts with multiple touchpoints.

Example:
- A prospect sees a LinkedIn ad (first touch)
- Searches your brand on Google and clicks an organic result (second touch)
- Returns a week later via a Google Ad (third touch)
- Fills out a form (conversion)
...
Credit goes to the first interaction (LinkedIn ad in the example).

Good for: Understanding what's driving awareness.

**Last-Touch Attribution**
Credit goes to the final interaction before conversion (Google Ad in the example).

Good for: Understanding what's closing deals.

**Linear Attribution**
Credit is split equally across all touchpoints.

Good for: Getting a balanced view, but often too simplistic.

**Time-Decay Attribution**
Credit weighted toward interactions closer to conversion.

Good for: B2B with longer sales cycles.

**Custom / Multi-Touch Attribution**
You define rules based on your funnel.

Good for: Complex funnels with multiple nurture steps.

### What to Use
For most businesses, start with **Last-Touch** in your reporting and layer in **First-Touch** to understand awareness drivers.

Don't overcomplicate it. Perfect attribution is impossible. Focus on directional accuracy.

## What to Ask Your Agency for Every Month

If you're working with an agency, here's what you should demand every month:

### 1. One-Page Executive Summary
- Top-line numbers: leads, cost per lead, pipeline value
...
Table showing:
- Channel (Organic, Paid Search, Paid Social, Direct, Referral)
- Leads generated
- Cost per lead
...
### 4. Site Performance
- Traffic (overall and to key pages)
- Bounce rate and time on page for top landing pages
- Conversion rate by page
- Any technical issues (broken forms, slow pages)
...
**Red Flag:** If your agency report is 40 slides of graphs with no action plan, you're being managed, not partnered with.

## Dashboards: What Should Be on Them

Don't build dashboards for the sake of it. Build them to answer specific questions.

### Dashboard 1: Marketing Overview (For Leadership)
...
### Dashboard 2: Campaign Performance (For Marketing Team)
- Active campaign performance (spend, conversions, ROAS)
- Traffic and conversion by landing page
- Ad creative performance (CTR, conversion rate)

Update: Daily or weekly.

### Dashboard 3: Website Conversion (For Optimisation)
- Top landing pages by traffic and conversion
- Form abandonment rate
- Heatmap insights (where users click, how far they scroll)

Update: Weekly.

### Dashboard 4: Sales & Marketing Alignment (For Sales + Marketing)
- Leads by source
...
Keep dashboards simple. If it takes more than 30 seconds to understand, it's too complex.

## Common Tracking Disasters and How to Avoid Them

### Disaster #1: No Conversion Tracking
You're running ads, but you don't know which ones are driving leads because conversion tracking isn't set up.

**Fix:** Set up conversion events in Google Analytics 4, Google Ads, and Meta Ads Manager. Track form submissions, phone clicks, and calendar bookings.

### Disaster #2: Broken Forms
Your main lead form isn't working (or is so long nobody fills it out).

**Fix:** Test all forms monthly. Use form analytics (Hotjar, GA4) to see where people drop off. Remove unnecessary fields.

### Disaster #3: Duplicate or Missing Data
Leads are coming in but they're not showing up in your CRM, or they're showing up twice.

**Fix:** Audit your integrations. Make sure form submissions are flowing to the CRM and not being blocked by validation errors.
...
**Fix:** Pick one source of truth (usually your CRM or GA4) and standardise reporting there. Document discrepancies but don't try to reconcile them perfectly.

## How Avorria Builds and Uses Dashboards with Clients

We don't believe in 40-page monthly reports. We believe in dashboards you can check anytime, and a short monthly call to walk through what matters.

### Our Standard Setup:
1. **CRM as the hub** (we integrate all traffic and lead sources)
2. **One shared dashboard** (accessible to client and our team)
