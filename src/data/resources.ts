...
export const resources: Resource[] = [
  {
    id: "seo-for-real-businesses",
    title: "The No-Bullshit Guide to SEO for Real Businesses",
    slug: "seo-for-real-businesses",
    summary: "SEO explained without the smoke and mirrors. What actually works, what's a waste of budget, and how to know if your current agency is delivering.",
    category: "SEO",
    readingTime: 18,
    serviceRelation: "seo",
    isPillar: true,
...
**Red Flag #1: No Clear Link to Business Outcomes**
If your monthly report shows "rankings up" but enquiries haven't moved, something's broken. Either they're targeting the wrong keywords, or your site isn't converting the traffic.

**Red Flag #2: They Never Talk About Conversion**
...
**Red Flag #5: No Tracking or Attribution**
If they can't show you which pages, keywords, or campaigns are driving leads, you have no idea what's working. Reporting without attribution is theatre.
...
1.⚠️ **What did we do this month?** (Specific tasks: pages optimised, links built, technical fixes deployed)
2.⚠️ **What impact did it have?** (Traffic to target pages, rankings for priority keywords, conversion events)
3.⚠️ **What are we doing next month?** (Clear priorities tied to outcomes)
...
Refresh existing content, expand into new topics, defend rankings from competitors. SEO is never "done," but the effort shifts from building to optimising.
...
**[Book a Strategy Call](/contact)** or⚠️ **[Request a Free SEO Audit](/free-seo-website-audit)**
`,
  },
  {
    id: "high-converting-websites",
    title: "High-Converting Websites: A Practical Playbook for Service Businesses",
    slug: "high-converting-websites-service-businesses",
    summary: "Most agency-built sites are designed to win awards, not customers. Here's how service businesses should actually build websites that turn visitors into pipeline.",
    category: "Web Design",
    readingTime: 16,
    serviceRelation: "web-design",
    isPillar: true,
...
High-converting websites for service businesses follow different rules:
-⚠️ **Clarity over cleverness**: Visitors should understand what you do in five seconds.
-⚠️ **Trust before engagement**: Prospects need proof you're credible before they'll pick up the phone.
-⚠️ **Action-focused design**: Every section should guide visitors toward a conversion event.
...
1. Qualify visitors quickly ("Is this for me?")
2. Build enough trust to justify a next step
3. Guide them to take that next step
...
Set up tracking for:
-⚠️ **Form submissions** (quote requests, contact forms, newsletter signups)
-⚠️ **Button clicks** (CTA buttons, phone numbers, calendar bookings)
-⚠️ **Scroll depth** (are people reading your content or bouncing?)
-⚠️ **Micro-conversions** (downloads, video plays, resource views)
...
**[Book a Strategy Call](/contact)** or⚠️ **[Request a Conversion Review](/contact)**
`,
  },
  {
    id: "marketing-analytics-guide",
    title: "Marketing Analytics That Actually Drive Decisions",
    slug: "marketing-analytics-that-drive-decisions",
    summary: "Most businesses are drowning in data but starving for insight. Here's how to set up tracking, reporting and dashboards that actually help you make better marketing decisions.",
    category: "Analytics",
    readingTime: 14,
...
"We have Google Analytics, but nobody really looks at it."
...
1.⚠️ **Where are our leads coming from?** (Channel attribution)
2.⚠️ **Which pages/campaigns are converting?** (Conversion tracking)
3.⚠️ **What's our cost per lead by channel?** (Efficiency measurement)
4.⚠️ **Where are prospects dropping off?** (Funnel analysis)
5.⚠️ **What should we do differently next month?** (Actionable insight)
...
### Common Mistakes:
-⚠️ **No conversion events set up**: GA4 tracks pageviews by default, but you need to manually configure form submissions, button clicks, and other conversion actions.
-⚠️ **No UTM tagging on campaigns**: If you're running ads or email campaigns without UTM parameters, GA4 can't attribute conversions properly.
-⚠️ **Enhanced Measurement left at defaults**: Some auto-tracked events (like scroll depth) aren't useful without context. Others (like file downloads) need enabling.
-⚠️ **No cross-domain tracking**: If your site spans multiple domains (e.g., main site + booking system), sessions break without proper configuration.
-⚠️ **Filters not applied**: Internal traffic (your team visiting the site) pollutes data.
...
-⚠️ **Use GA4's data-driven attribution model** (it's the default and uses machine learning)
-⚠️ **Track first-touch AND last-touch sources** in your CRM
-⚠️ **Use UTM parameters consistently** across all channels
-⚠️ **Review assisted conversions** in GA4 to see which channels support (not just close) deals
...
1.⚠️ **One dashboard per audience**: Marketing team sees campaign metrics. Sales sees lead quality. Leadership sees cost per acquisition and ROI.
2.⚠️ **Lead with actions, not vanity**: "Organic leads up 22%, recommend scaling content budget" beats "Sessions: 14,392."
3.⚠️ **Include comparisons**: This week vs last week. This month vs same month last year. Without context, numbers are meaningless.
4.⚠️ **Update automatically**: Manual dashboards get abandoned. Use tools that pull data in real-time.

### Recommended Stack:
-⚠️ **Looker Studio** (free, connects to GA4, Search Console, Google Ads)
-⚠️ **HubSpot dashboards** (if you're already using HubSpot CRM)
-⚠️ **Notion + manual updates** (for lightweight reporting)
...
1.⚠️ **Performance snapshot**: Key metrics with context (vs last period, vs target)
2.⚠️ **Insights**: What worked, what didn't, and why
3.⚠️ **Recommendations**: Specific actions for the next period

### Reporting Cadence:
1.⚠️ **Daily quick-check** (ad spend, lead count—takes 2 minutes)
2.⚠️ **Weekly tactical review** (campaign performance, content metrics)
3.⚠️ **Weekly automated summary** (emailed snapshot of key metrics)
4.⚠️ **Monthly strategy call** (30 minutes: what worked, what didn't, what's next)

We build dashboards in:
-⚠️ **HubSpot** (if client is already using it)
-⚠️ **Looker Studio** (free, flexible, integrates with GA4 and ad platforms)
-⚠️ **Notion** (for lightweight reporting with commentary)
...
At Avorria, we offer:
-⚠️ **Full analytics audits** (GA4, CRM, ad platform setup review)
-⚠️ **Tracking overhauls** (clean implementation from scratch)
-⚠️ **Custom dashboard builds** (one source of truth, no filler)

We don't do this as an upsell—it's often the first thing we do, because you can't optimise what you can't measure.

**[Book a Strategy Call](/contact)** or⚠️ **[Request a Free Analytics Audit](/contact)**
`,
  },
  // ----------- NEW NON-PILLAR RESOURCES -----------
  {
    id: "local-seo-dominate-city",
    title: "Local SEO: How to Dominate Your City",
    slug: "local-seo-dominate-your-city",
    summary: "If you serve a specific area, local SEO is the fastest path to qualified leads. Here's how to own your city in Google without wasting budget on national terms.",
    category: "SEO",
    readingTime: 10,
    serviceRelation: "seo",
    isPillar: false,
    targetKeyword: "local SEO guide",
    metaTitle: "Local SEO: How to Dominate Your City | Avorria",
    metaDescription: "A practical guide to local SEO for service businesses. Google Business Profile, local citations, reviews, and location pages that actually drive enquiries.",
...
1.⚠️ **Google Business Profile** (the map pack)
2.⚠️ **Localised website pages** (city + service landing pages)
3.⚠️ **Citations and reviews** (trust signals Google uses to rank local businesses)
...
-⚠️ **Complete every field**: Business name, address, phone, hours, website, services, description
-⚠️ **Choose the right primary category**: This matters more than most people think. "Plumber" and "Plumbing Service" rank differently
-⚠️ **Add photos weekly**: Google rewards active profiles. Upload real photos of your work, team, and premises
-⚠️ **Enable messaging**: Prospects can message you directly from search results
-⚠️ **Post updates regularly**: Google Posts keep your profile active and can include offers, events, or news
-⚠️ **Collect and respond to reviews**: More on this below
...
### The Right Way:
-⚠️ **Unique content per page**: Each location page should have genuinely different content—local case studies, area-specific service details, team members who cover that area
-⚠️ **Clear H1 structure**: "Plumbing Services in Leeds" not "Our Services"
-⚠️ **Embedded Google Map**: Shows Google this page is genuinely relevant to that location
-⚠️ **Local schema markup**: LocalBusiness or Service schema with the specific area
-⚠️ **Internal linking**: Link from your main services pages to location pages
...
-⚠️ **Make it easy**: Use a short URL or QR code. Don't make customers search for your listing
-⚠️ **Follow up once**: A polite email or text 2-3 days later. Don't badger
-⚠️ **Respond to every review**: Positive or negative. This shows Google (and prospects) that you're active and care

### Handling Negative Reviews:
-⚠️ **Don't ignore them**: Respond professionally, acknowledge the issue, offer to resolve it
-⚠️ **Don't fake positive reviews**: Google's detection is getting better. It's not worth the risk
-⚠️ **Don't panic**: One bad review among 50 good ones actually increases trust (perfect 5.0 ratings look suspicious)
...
-⚠️ **Map pack visibility**: Are you showing in the top 3 for your target searches?
-⚠️ **GBP insights**: Calls, direction requests, website clicks from your profile
-⚠️ **Local keyword rankings**: Position tracking for "[service] + [city]" terms
-⚠️ **Review velocity**: How many new reviews per month?
-⚠️ **Local organic traffic**: GA4 filtered to your target geographic areas
...
**[Book a Strategy Call](/contact)** or⚠️ **[Request a Local SEO Audit](/contact)**
`,
  },
  {
...
### 2. Is Your Site Fast?
**Check:** Run your homepage through [Google PageSpeed Insights](https://pagespeed.web.dev/).
...
**Check:** Use Google's [Mobile-Friendly Test](https://search.google.com/test/mobile-friendly) or just load your site on your phone.
...
**Check:** Use [Google's Rich Results Test](https://search.google.com/test/rich-results) and paste your homepage URL.
...
`,
  },
  {
    ...
    title: "Landing Page Anatomy: What Goes Where and Why",
    slug: "landing-page-anatomy",
    summary: "A high-converting landing page isn't random. Every section exists for a reason. Here's the exact structure we use to build pages that convert at 5-12%.",
    category: "Web Design",
    readingTime: 9,
    serviceRelation: "web-design",
    isPillar: false,
    targetKeyword: "landing page structure",
    metaTitle: "Landing Page Anatomy: What Goes Where and Why | Avorria",
    metaDescription: "The exact landing page structure that converts at 5-12% for service businesses. Every section explained with examples and common mistakes to avoid.",
    publishedDate: "2025-02-12",
    content: `## Why Structure Matters More Than Design
...
1.⚠️ **Multiple CTAs competing for attention**: One primary action per page
2.⚠️ **No mobile optimisation**: 60%+ of traffic is mobile. Test everything on a phone first
3.⚠️ **Slow load times**: Every second of load time costs you ~7% in conversions
4.⚠️ **Stock photography**: Real photos of your team/work build 3x more trust
5.⚠️ **Too much text**: Landing pages aren't blog posts. Edit ruthlessly

## Testing Your Landing Page

Before driving traffic, run these checks:
-⚠️ **5-second test**: Show someone the page for 5 seconds. Can they tell you what you offer and who it's for?
-⚠️ **CTA clarity**: Is the primary action obvious without scrolling?
-⚠️ **Mobile test**: Load it on your phone. Is everything readable and tappable?
-⚠️ **Speed test**: Under 2.5 seconds on mobile?

Then launch, drive traffic, and measure. Optimise based on data, not opinions.

**[Get a Landing Page Built for Conversion](/contact)**
`,
  },
  {
    id: "website-redesign-vs-optimisation",
    title: "Website Redesign vs Optimisation: A Decision Framework",
    slug: "website-redesign-vs-optimisation",
    summary: "Not every underperforming website needs a full rebuild. Sometimes targeted optimisation gets better results, faster and cheaper. Here's how to decide.",
    category: "Web Design",
    readingTime: 7,
    serviceRelation: "web-design",
    isPillar: false,
    targetKeyword: "website redesign or optimise",
    metaTitle: "Website Redesign vs Optimisation: A Decision Framework | Avorria",
    metaDescription: "Should you redesign your website or optimise what you have? A practical framework for making the right call based on data, not gut feeling.",
    publishedDate: "2025-02-15",
    content: `## The Redesign Trap
...
|----------|----------|----------|
| Is the tech stack modern? | ✅ Yes | â— No |
| Is the site mobile-responsive? | ✅ Yes | â— No |
| Can you make content changes easily? | ✅ Yes | â— No |
| Is the brand still relevant? | ✅ Yes | â— No |
| Are problems isolated to specific pages? | ✅ Yes | â— Problems are systemic |
...
### For Optimisation:
1. Share your current analytics (GA4, Search Console)
2. Identify the specific problem: "Homepage converts at 0.8%, we want 3%"
3. Agree on success metrics before starting
4. Allow 4-8 weeks for implementation and testing

### For Redesign:
1. Define your goals in business terms (leads, conversions, not "looks modern")
2. Share brand guidelines, competitive examples, and content inventory
3. Plan for content: who's writing it, when it's due, what format
4. Budget for post-launch optimisation (the first version is never the final version)

**[Get a Conversion Review of Your Current Site](/contact)**
`,
  },
  {
...
-⚠️ **Sitelinks**: Link to specific service pages, case studies, contact page
-⚠️ **Callouts**: "Free Audit", "No Contracts", "Same-Day Response"
-⚠️ **Structured snippets**: List your services
-⚠️ **Call extension**: Add your phone number
-⚠️ **Location extension**: Show your address (if local)
...
### Essential Tracking:
-⚠️ **Form submissions**: Track every form completion as a conversion
-⚠️ **Phone calls**: Use call tracking (Google's forwarding number or a tool like CallRail)
-⚠️ **Chat conversations**: Track chat initiations if you use live chat
-⚠️ **Offline conversions**: Import CRM data back into Google Ads to tell it which leads became customers

### Metrics That Matter:
-⚠️ **Cost per lead (CPL)**: What you pay per form fill or call
-⚠️ **Conversion rate**: Percentage of clicks that convert
-⚠️ **Quality score**: Google's rating of your ad relevance (affects cost)
-⚠️ **Search impression share**: Percentage of available impressions you're capturing

## Common Mistakes to Avoid

1.⚠️ **No negative keywords**: Add negatives from day one ("free", "jobs", "DIY", competitor names you don't want to bid on)
2.⚠️ **Targeting too broad**: Start with your core service area, not the whole country
3.⚠️ **Ignoring search terms report**: Review weekly. Add negatives. Find new keyword opportunities.
4.⚠️ **Set and forget**: Google Ads requires weekly optimisation. If nobody's looking at it, you're wasting money.
...
**[Book a Strategy Call](/contact)** or⚠️ **[Request a Free PPC Audit](/contact)**
`,
  },
  {
    ...
    metaTitle: "Meta Ads vs Google Ads: Where to Spend First | Avorria",
    metaDescription: "Should you spend your first ad budget on Meta or Google? A practical comparison for service businesses, with clear guidance on where to invest first.",
...
|--------|-----------|----------|
|⚠️ **Intent** | High (active search) | Low (passive browsing) |
|⚠️ **Speed to leads** | Very fast (48 hrs) | Moderate (1-2 weeks to optimise) |
|⚠️ **Cost per lead** | Higher per click, but higher intent | Lower per click, but needs more volume |
|⚠️ **Creative needs** | Text-based ads (simpler) | Visual creative needed (images/video) |
|⚠️ **Best audience** | People searching now | People who match your ideal profile |
|⚠️ **Learning curve** | Moderate | Steeper (creative + targeting + attribution) |
|⚠️ **Remarketing** | Good | Excellent |
|⚠️ **Brand building** | Weak | Strong |
|⚠️ **B2B effectiveness** | Strong | Moderate (LinkedIn often better) |
|⚠️ **Measurability** | Very clear | Muddier (attribution challenges) |
...
1.⚠️ **Choosing based on what's trendy**: Pick based on where your customers are, not what's popular in marketing circles
2.⚠️ **Expecting Meta results on day one**: Meta's algorithm needs 50+ conversions per week to optimise properly. Be patient.
3.⚠️ **Sending Meta traffic to your homepage**: Build dedicated landing pages. Always.
4.⚠️ **Not tracking offline conversions**: If leads convert by phone, you need call tracking on both platforms
5.⚠️ **Comparing apples to oranges**: Google Ads CPL will always look different from Meta CPL. Compare lead quality and close rates, not just cost.
...
**[Get a Paid Media Strategy Call](/contact)**
`,
  },
  {
    id: "ga4-setup-guide",
    ...
    serviceRelation: "analytics",
    isPillar: false,
    targetKeyword: "GA4 setup guide",
    metaTitle: "GA4 Setup Guide: What to Track From Day One | Avorria",
    metaDescription: "A practical GA4 setup guide for business owners. What to track, how to configure it, and the common mistakes that make your data useless.",
...
### Useful Audiences:
-⚠️ **Engaged visitors**: Session duration > 60 seconds AND viewed 2+ pages
-⚠️ **Service page viewers**: Visited any URL containing "/services/"
-⚠️ **Blog readers**: Visited any URL containing "/resources/" or "/blog/"
-⚠️ **Converters**: Triggered any conversion event
-⚠️ **High-value prospects**: Viewed pricing page AND visited 3+ times
...
### What to Include:
1.⚠️ **Users and Sessions** (with week-over-week comparison)
2.⚠️ **Top Landing Pages** (where people enter your site)
3.⚠️ **Conversion Events** (form fills, calls, CTA clicks)
4.⚠️ **Traffic Sources** (organic, paid, direct, social, referral)
5.⚠️ **Device Breakdown** (desktop vs mobile performance)

### Where to Build It:
-⚠️ **GA4 Explorations**: Good for ad-hoc analysis
-⚠️ **Looker Studio**: Better for ongoing dashboards you share with your team
-⚠️ **GA4 Custom Reports**: Quick views you check daily

## Common GA4 Mistakes

1.⚠️ **Not marking events as conversions**: Events are just data points until you tell GA4 they matter
2.⚠️ **Tracking too many events**: Focus on 5-8 key events, not 50. More events = more noise
3.⚠️ **Not using UTM parameters**: Tag every campaign, email, and ad with UTM parameters so GA4 can attribute traffic correctly
4.⚠️ **Ignoring the Realtime report**: Use it to verify your tracking is working correctly after setup
5.⚠️ **Not setting up cross-domain tracking**: If your site spans multiple domains, configure cross-domain tracking or your user journeys will break
6.⚠️ **Forgetting to check data retention settings**: GA4 defaults to 2 months. Set it to 14 months under Admin — Data Settings — Data Retention
...
**[Request a Tracking Audit](/contact)**
`,
  },
  {
    id: "how-to-brief-marketing-agency",
    title: "How to Brief a Marketing Agency (Without Wasting Everyone's Time)",
    slug: "how-to-brief-marketing-agency",
    summary: "A bad brief leads to bad work. Here's how to write a marketing agency brief that gets you better proposals, faster results, and fewer expensive misunderstandings.",
    category: "Strategy",
    readingTime: 7,
    serviceRelation: undefined,
    isPillar: false,
    targetKeyword: "how to brief marketing agency",
    metaTitle: "How to Brief a Marketing Agency (Without Wasting Everyone's Time) | Avorria",
    metaDescription: "How to write a marketing agency brief that actually works. Template included, plus the common mistakes that lead to bad proposals and wasted budgets.",
    publishedDate: "2025-03-05",
    content: `## Why Most Agency Briefs Fail
...
-⚠️ **Specific:** "Generate 30 qualified leads per month from organic search"
-⚠️ **Measurable:** "Reduce cost per lead from —80 to —40"
-⚠️ **Time-bound:** "Achieve this within 6 months"

**Don't say:** "Improve our online presence." That means different things to different people.

### 4. Scope and Constraints
Be honest about boundaries:
-⚠️ **Budget:** Give a realistic range. "—2,000-3,000/month" is infinitely more useful than "competitive rates."
-⚠️ **Timeline:** When do you need to see results? What's your deadline?
-⚠️ **Internal resources:** What can you do in-house? (Content writing, design, development)
-⚠️ **Approval process:** How many people need to sign off? How long does that take?
...
A good agency will respond to your brief with:
1.⚠️ **Clarifying questions** (if they don't ask questions, they didn't read it properly)
2.⚠️ **A strategic recommendation** (not just "here's what you asked for" but "here's what we think you actually need")
3.⚠️ **A clear scope and timeline**
4.⚠️ **Pricing tied to deliverables** (not vague "ongoing support" packages)
...
export const getPillarResources = (): Resource[] => {
  return resources.filter((r) => r.isPillar);
};
