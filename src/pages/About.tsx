...
const team = [
  {
    ...
    bio: "Spent a decade inside B2B and SaaS businesses watching agencies burn budgets on vanity metrics. Started Avorria to build the agency he wished he'd hired — one that thinks like an owner, not a supplier.",
  },
  {
    initials: "SR",
    name: "Sophie Reynolds",
    title: "Head of SEO & Technical",
    bio: "Former in-house SEO lead for a £40M e-commerce brand. Obsessed with site architecture, Core Web Vitals and the kind of technical detail that actually moves rankings — not just blog posts.",
  },
  {
    initials: "MK",
    name: "Marcus Keane",
    title: "Head of Paid Media & CRO",
    bio: "Has managed over £8M in ad spend across Google, Meta and LinkedIn. Believes every pound should be accountable and that landing pages matter more than audience targeting.",
  },
  {
    initials: "AL",
    name: "Ava Linton",
    title: "Head of Design & Development",
    bio: "Designs websites that convert, not just look good. Background in UX research and front-end development means every layout decision is backed by data and built to perform.",
  },
];
        ...
        <section className="relative min-h-[85vh] flex items-center overflow-hidden -mt-20 pt-20">
          ...
          <div className="container mx-auto px-6 relative z-10">
            <div className="max-w-2xl">
              <motion.span
                className="inline-block text-xs sm:text-sm font-medium text-white/50 uppercase tracking-[0.2em] mb-4"
              ...
              <motion.h1
                className="text-3xl sm:text-4xl md:text-5xl font-light leading-[1.1] tracking-tight text-white/95 mb-6"
            ...
            <div className="container mx-auto px-4 sm:px-6">
              <div className="max-w-5xl mx-auto">
                <ScrollReveal variant="fade-up" duration={500}>
                  ...
                  <h2 className="text-3xl sm:text-4xl md:text-5xl font-light text-foreground mb-12">
                    Why Avorria exists.
                  </h2>
                </ScrollReveal>
                ...
                <div className="grid md:grid-cols-5 gap-12 items-start">
                  <ScrollReveal variant="fade-up" delay={100} duration={500} className="md:col-span-3">
                    <div className="space-y-6 text-muted-foreground leading-relaxed">
                      <p>
                        Before Avorria, we spent years working inside businesses — not agencies. We sat in the meetings where marketing budgets were questioned, where dashboards full of impressions meant nothing to the board, and where "the agency" was just another line item nobody could justify.
                      </p>
                      <p>
                        We watched good companies hand over five-figure monthly retainers to agencies that delivered activity reports instead of results. Agencies that confused being busy with being effective. That prioritised their own award entries over their client's pipeline.
                      </p>
                      <p>
                        So we built something different. Avorria is deliberately small. Every client works directly with senior people who've managed real P&Ls, fixed broken tracking stacks, rebuilt websites that weren't converting, and turned paid media from a cost centre into a growth engine.
                      </p>
                      <p>
                        We don't do fluff. We don't do vanity metrics. We do the hard, unglamorous work that actually moves the numbers — and we're transparent about what's working and what isn't.
                      </p>
                    </div>
                  </ScrollReveal>
                  ...
                  <ScrollReveal variant="fade-up" delay={200} duration={500} className="md:col-span-2">
                    <div className="border-l-2 border-accent/40 pl-6 py-2">
                      <p className="text-xl md:text-2xl font-light text-foreground italic leading-relaxed">
                        "We'd rather lose a pitch by being honest than win one by overpromising."
                      </p>
              ...
              <div className="max-w-5xl mx-auto">
                ...
                <ScrollRevealGrid className="grid md:grid-cols-2 gap-6" stagger={100} variant="fade-up">
                  {principles.map((principle, index) => (
                    <div
                      key={index}
                      className="p-8 rounded-xl border border-white/10 bg-white/[0.03] transition-all duration-300 hover:bg-white/[0.06] hover:-translate-y-1"
                    >
              ...
              <div className="max-w-5xl mx-auto">
                ...
                <ScrollRevealGrid className="grid sm:grid-cols-2 gap-6" stagger={100} variant="fade-up">
                  {team.map((member, index) => (
                    <div
                      key={index}
                      className="p-8 rounded-xl border border-border/60 bg-card/50 transition-all duration-300 hover:-translate-y-1 hover:shadow-lg hover:shadow-black/5"
                    >
                      <div className="flex items-start gap-5">
                        <div className="w-14 h-14 rounded-full bg-accent/10 border border-accent/20 flex items-center justify-center text-accent text-sm font-semibold flex-shrink-0">
                          {member.initials}
                        </div>
                  ...
                  <div className="grid md:grid-cols-3 gap-0 relative">
                    ...
                    {howWeWork.map((item, index) => (
                      <div key={index} className="relative text-center px-6 py-8 md:py-0">
                        <div className="relative z-10 w-20 h-20 rounded-full border border-white/15 bg-white/[0.04] flex items-center justify-center text-accent text-xl font-semibold mx-auto mb-6">
                          {item.step}
                        </div>
            ...
            <ScrollReveal variant="fade-up" duration={600}>
              <div className="max-w-3xl mx-auto text-center">
                ...
                <p className="text-lg text-white/60 mb-10 max-w-xl mx-auto">
                  Book a strategy call to discuss your goals, challenges, and where the biggest opportunities are hiding.
                </p>
