        ...
        <section className="container mx-auto px-4 mb-20">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <p className="text-lg text-muted-foreground mb-8 max-w-3xl mx-auto">
              If your monthly PDF is 40 slides of charts and no clear next steps, you're not alone. 
              Send us your latest report or proposal and we'll break it down in plain English – what's solid, 
              what's fluff, and where you're being short-changed.
            </p>
