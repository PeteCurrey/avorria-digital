...
const ContentEmail = () => {
  const painPoints = [
    "You've got a blog, but it's not driving any leads – just random traffic that never converts.",
    "Your email list is gathering dust because nobody knows what to send or when.",
    "Content gets produced, but there's no strategy connecting it to your sales process.",
    "You're creating content for the sake of it, without clear commercial intent.",
    "Your email open rates are fine, but nothing actually happens after people read them.",
  ];

  const contentIncluded = [
    "Content strategy tied to your buyer journey and commercial goals.",
    "Keyword research focused on high-intent, bottom-of-funnel terms.",
    "Topic clusters and pillar content planning.",
    "Long-form SEO content that ranks and converts.",
    "Case studies, comparison pages and sales enablement assets.",
    "Content refresh and optimisation for existing assets.",
  ];

  const emailIncluded = [
    "Email strategy and sequence mapping.",
    "Welcome sequences that educate and qualify.",
  ...
  const timeline = [
    {
      ...
      description:
        "We review your existing content and email setup, identify gaps and map out a plan tied to your sales process and commercial goals.",
    },
    {
      period: "Weeks 3–6",
      title: "Foundation content",
      description:
        "Launch core content assets – pillar pages, key blog posts, and foundational email sequences that work while you sleep.",
    },
    {
      period: "Months 2–3",
      title: "Scale & optimise",
      description:
        "Expand content clusters, refine email sequences based on data, and build out sales enablement materials.",
    },
    {
      period: "Ongoing",
      title: "Compound & convert",
      description:
        "Regular content production, email campaigns, and continuous optimisation based on what's actually driving pipeline.",
    },
  ];

  const deliverables = [
    "Monthly content calendar with clear commercial rationale.",
    "Email sequences mapped to buyer journey stages.",
    "Performance dashboards showing content traffic, engagement and leads.",
    "Regular optimisation recommendations based on real data.",
    "Quarterly strategy reviews to refine approach.",
  ];
  ...
  const faqs = [
    {
      ...
      answer:
        "Both. We can handle everything from strategy through to writing and publishing, or work alongside your in-house team to execute on our plans.",
    },
    {
      question: "What email platforms do you work with?",
      answer:
        "Most of them – HubSpot, ActiveCampaign, Mailchimp, ConvertKit, Klaviyo and more. We'll work with what you have or recommend alternatives if needed.",
    },
    {
      question: "How do you measure content success?",
      answer:
        "Traffic and rankings matter, but we focus on leads and pipeline. Every piece of content should have a clear role in moving people toward a conversion.",
    },
    {
      question: "How often should we be sending emails?",
      answer:
        "It depends on your audience and offer. We'll help you find the right cadence that keeps you top of mind without burning your list.",
    },
  ];
  ...
  return (
    <>
      ...
      <div className="min-h-screen">
        {/* Hero Section */}
        <HeroBand
          headline="Content and email that feed your pipeline."
          body="We create strategic content that attracts the right people and email sequences that move them through your funnel – not just blog posts and newsletters that nobody reads."
          backgroundImage={heroContentEmail}
          cta={{ text: "Book a content strategy call", href: "/contact" }}
          secondaryCta={{ text: "Get a free content audit", href: "/free-seo-website-audit" }}
        />
              ...
              <ScrollReveal>
                <div className="space-y-6">
                  ...
                  <div className="space-y-4">
                    {contentIncluded.map((item, index) => (
