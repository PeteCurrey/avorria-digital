  ...
  return (
    <>
      ...
      <BreadcrumbSchema items={[
        ...
        { name: "SEO Glossary", url: "https://avorria.com/resources/seo-glossary" }
      ]} />
                      ...
                      {term.seeAlso && term.seeAlso.length > 0 && (
                        <div className="flex flex-wrap gap-2 items-center">
                          ...
                          {term.seeAlso.map((link, i) => (
                            <Link key={i} href={link} className="text-sm text-primary hover:text-primary/80 hover:underline transition-colors capitalize">{link.split(`/`).pop()?.replace(/-/g, ` `)}</Link>
                          ))}
                        </div>
                      )}
                    </CardContent>
